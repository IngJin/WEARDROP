...
public class Buydetail extends AppCompatActivity implements Runnable {
    String id;
    String filepath;
    ImageView imageView;
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.menuitem_bottombar_home:
                                Intent intent = new Intent(Buydetail.this, Buy.class);
                                ...
                                builder1.setPositiveButton("예",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Intent intent = new Intent(Buydetail.this, BuyUpdateActivity.class);
                            ...
                            case R.id.menuitem_bottombar_delete:
                                ...
                                builder2.setPositiveButton("예",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                 Thread th = new Thread(Buydetail.this);
                                                 th.start();
                                                 finish();
                                            }
                                        });
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (message != null) {
                            ...
                            intent.putExtra("dto", dto);
                            startActivity(intent);
                            Toast.makeText(Buydetail.this,"게시글이 삭제되었습니다.", Toast.LENGTH_LONG).show();
