...
public class BuywriteActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    //변수 선언
    private Button ImageBtn, add_btn, cancle_btn; //레이아웃에서 사용했던 Button
    private ImageView add_image_view; //레이아웃에서 사용했던 ImageView
    private EditText title, price, content; //레이아웃에서 사용했던 EditText
    private TextView writer, userid;
    Spinner Spinner;
    String code, filepath;
    // Request를 요청 할 URL
    private String upload_URL = "http://112.164.58.217:80/weardrop_app/commu2.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buywrite);
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    if(code=="1"){
                        Intent saleintent = new Intent(BuywriteActivity.this, SellActivity.class);
                        finish();
                    }else if(code=="2"){
                        Intent freeintent = new Intent(BuywriteActivity.this, Buy.class);
                        finish();
                    }
                    Toast.makeText(BuywriteActivity.this, "게시글이 저장되었습니다. 새로고침해주세요!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        if (requestCode == GALLERY) { // requestCode가 GALLERY 일때 갤러리에서 사진을 가져오는 동작
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(BuywriteActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    // [190806 화요일]
    // VolleyMultipartRequest2 클래스 생성 필요
    // 별건 없고 복붙하면 됨
    ...
    private void uploadImage(final Bitmap bitmap) {
        ...
        //VolleyMultipartRequest2 호출
        VolleyMultipartRequest volleyMultipartRequest2 = new VolleyMultipartRequest
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try{
                    ...
                    params.put(URLEncoder.encode("writer", "UTF-8"), URLEncoder.encode
                            (writer.getText().toString(), "UTF-8"));  //add string parameters
                    params.put(URLEncoder.encode("title", "UTF-8"), URLEncoder.encode
                            (title.getText().toString(), "UTF-8"));  //add string parameters
                    params.put(URLEncoder.encode("price", "UTF-8"), URLEncoder.encode
                            (price.getText().toString(), "UTF-8"));  //add string parameters
        ...
        rQueue = Volley.newRequestQueue(BuywriteActivity.this);
