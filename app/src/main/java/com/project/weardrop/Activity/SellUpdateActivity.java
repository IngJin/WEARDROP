...
public class SellUpdateActivity extends AppCompatActivity {
    String id, userid, title, price, content, writer, code, filepath;
    private TextView addWriter;                                                                   //레이아웃에서 사용했던 TextView
    private EditText addTitle, addPrice, addContent, addUserid;                                                       //레이아웃에서 사용했던 EditText
    private ImageView add_image_view;                                                            //레이아웃에서 사용했던 ImageView
    private Button ImageBtn, add_btn, cancle_btn;                                               //레이아웃에서 사용했던 Button
    private String upload_URL = "http://112.164.58.217:80/weardrop_app/andupdate2.com";         // Request를 요청 할 URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i("previous data ======> ",id + " , " + title + " , " + writer + " , " + content);

        //activity_buy_update.xmll id 값
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(SellUpdateActivity.this, SellActivity.class);
                intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent1.putExtra("dto", dto);
                startActivity(intent1);
                Toast.makeText(SellUpdateActivity.this, "게시글이 수정되었습니다. 새로고침 해주세요!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        if (requestCode == GALLERY) {                       // requestCode가 GALLERY 일때 갤러리에서 사진을 가져오는 동작
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(SellUpdateActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void uploadImage(final Bitmap bitmap) {
        //VolleyMultipartRequest2 호출    - Response.Listener(): 응답을 성공적으로 받았을 때 리스너의 onResponse 메소드를 자동으로 호출
        VolleyMultipartRequest volleyMultipartRequest2 = new VolleyMultipartRequest(Request.Method.POST, upload_URL, new Response.Listener<NetworkResponse>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    params.put(URLEncoder.encode("price", "UTF-8"), URLEncoder.encode(addPrice.getText().toString(), "UTF-8"));
        ...
        volleyMultipartRequest2.setRetryPolicy(new DefaultRetryPolicy(0, DefaultRetryPolicy.DEFAULT_MAX_RETRIES, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));

        rQueue = Volley.newRequestQueue(SellUpdateActivity.this);
        rQueue.add(volleyMultipartRequest2);                             // request queue 에 request 객체를 넣어준다.
    }
