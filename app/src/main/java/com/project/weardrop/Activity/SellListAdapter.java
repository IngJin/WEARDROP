...
public class SellListAdapter extends RecyclerView.Adapter<SellListAdapter.ViewHolder> {
    ...
    private ArrayList<Selllistitem> mItems;
    ...
    public void setOnItemClickListener(SellListAdapter.OnItemClickListener listener){
        mListener = listener;
    }

    public SellListAdapter(Context mContext, ArrayList<Selllistitem> items){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.sell_cardview, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Selllistitem item = mItems.get(position);
