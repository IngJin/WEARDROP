...
public class BuyListAdapter extends RecyclerView.Adapter<BuyListAdapter.ViewHolder> {
    ...
    private ArrayList<Buylistitem> mItems;
    ...
    public BuyListAdapter(Context mContext, ArrayList<Buylistitem> items) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.buy_cardview, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Buylistitem item = mItems.get(position);
