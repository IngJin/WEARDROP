...
public class SaleUpdateActivity extends AppCompatActivity {
    ...
    private String upload_URL = "http://192.168.0.21:80/teamproject/andupdate.com";         // Request를 요청 할 URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("http://192.168.0.21:80/teamproject/resources" + filepath).into(add_image_view);
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(SaleUpdateActivity.this, SaleActivity.class);
                intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent1);
                Toast.makeText(SaleUpdateActivity.this, "게시글이 수정되었습니다. 새로고침 해주세요!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        if (requestCode == GALLERY) {                       // requestCode가 GALLERY 일때 갤러리에서 사진을 가져오는 동작
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(SaleUpdateActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void uploadImage(final Bitmap bitmap) {
        ...
        rQueue = Volley.newRequestQueue(SaleUpdateActivity.this);
