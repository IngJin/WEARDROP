                        ...
                        switch (item.getItemId()) {
                                ...
                                builder1.setPositiveButton("예",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(SaledetailActivity.this, SaleUpdateActivity.class);
                            ...
                            case R.id.menuitem_bottombar_delete:
                                ...
                                builder2.setPositiveButton("예",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                               Thread th = new Thread(SaledetailActivity.this);
                                               th.start();
                                               finish();
                                            }
                                        });
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (message != null) {
                        ...
                        startActivity(intent);
                        Toast.makeText(SaledetailActivity.this,"게시글이 삭제되었습니다.", Toast.LENGTH_LONG).show();
