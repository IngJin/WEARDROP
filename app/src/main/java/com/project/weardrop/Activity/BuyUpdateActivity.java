...
public class BuyUpdateActivity extends AppCompatActivity {
    String id, userid, title, content, writer, code, filepath, price;
    private TextView addWriter, addUserid;                                                                   //레이아웃에서 사용했던 TextView
    private EditText addTitle, addContent, addprice;                                                       //레이아웃에서 사용했던 EditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addUserid = findViewById(R.id.userid);
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(BuyUpdateActivity.this, Buy.class);
                intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent1.putExtra("dto", dto);
                startActivity(intent1);
                Toast.makeText(BuyUpdateActivity.this, "게시글이 수정되었습니다. 새로고침 해주세요!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        if (requestCode == GALLERY) {                       // requestCode가 GALLERY 일때 갤러리에서 사진을 가져오는 동작
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(BuyUpdateActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void uploadImage(final Bitmap bitmap) {
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, upload_URL, new Response.Listener<NetworkResponse>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    params.put(URLEncoder.encode("price", "UTF-8"), URLEncoder.encode(addprice.getText().toString(), "UTF-8"));  //add string parameters
        ...
        rQueue = Volley.newRequestQueue(BuyUpdateActivity.this);
