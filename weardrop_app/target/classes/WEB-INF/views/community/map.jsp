...
<body>
	<div class="map_wrap">
		<div id="map"
			style="width: 565px; height: 660px; position: relative; overflow: hidden;">
		</div>
		<div id="menu_wrap" class="bg_white">
			<div class="option">
				<div>
					<form onsubmit="searchPlaces(); return false;">
						<input type="text" placeholder="지역명 + 옷가게 로 입력하세요." id="keyword" size="50" style="height:36px; width:410px; font-size:15px">
					</form>
					<a><img class=searchBtn onclick="$('form').submit()" src="img/search_white.png"></a>
				</div>
			</div>
			<hr>
			<ul id="placesList"></ul>
